...
export class ItemPage extends BasePage {
    ...
    private readonly emailInput = this.page.locator('id=ec_account_login_widget_email');
    private readonly signButton = this.page.getByRole('button', { name: 'SIGN IN' });
    private readonly addToCartButton = this.page.getByRole('button', { name: 'ADD TO CART' })
    private readonly submitButton = this.page.getByRole('button', { name: 'Post Comment' })
